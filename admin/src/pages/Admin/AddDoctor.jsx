    ...
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div>
              ...
              <textarea onChange={(e)=> setAbout(e.target.value)} value={about} className="w-full px-4 pt-2 border rounded mt-2" placeholder='write about doctor' rows={5} required/>
          </div>

          <button type='submit' className="bg-primary text-white rounded-full px-10 py-3 ml-8 hover:bg-green-400">Add doctor</button>
